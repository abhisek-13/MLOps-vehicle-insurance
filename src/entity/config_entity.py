...
class DataTransformationConfig:
  ...
  transformed_train_file_path: str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRASFORMED_DATA_DIR, TRAIN_FILE_NAME.replace("csv","npy"))
  transformed_test_file_path: str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRASFORMED_DATA_DIR, TEST_FILE_NAME.replace("csv","npy"))
  transformed_object_file_path: str = os.path.join(data_transformation_dir, DATA_TRANSFORMATION_TRASFORMED_OBJECT_DIR, PREPROCESSING_OBJECT_FILE_NAME)
