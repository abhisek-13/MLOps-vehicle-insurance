...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        try:
          ...
          logging.info(f"Exported data with shape: {dataframe.shape}")
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        ...
        On Failure  :   Write an exception log and then raise an exception
        """
        logging.info("Entering into split_data_as_train_test method of DataIngestion class")
        try:
          ...
          logging.info("Exiting from the split_data_as_train_test method of DataIngestion class")
          
          dir_path = os.path.dirname(self.data_ingestion_config.training_file_path)
          os.makedirs(dir_path, exist_ok=True)
          
          logging.info("Saving train and test data into respective file paths")
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
      ...
      On Failure  :   Write an exception log and then raise an exception
      """
      logging.info("Entering into initiate_data_ingestion method of DataIngestion class")
      ...
      try:
        ...
        logging.info("Exiting from the initiate_data_ingestion method of DataIngestion class")
