...
class DataTransformation:
    ...
    def get_data_transformed_object(self) -> Pipeline:
        ...
        """
        logging.info("Entering into get_data_transformed_object method of DataTransformation class")
        
        try:
          # Initialize transformer objects
          numeric_transformer = StandardScaler()
          categorical_transformer = MinMaxScaler()
          ...
          preprocessor = ColumnTransformer(
              transformers=[
                  ...
                  ('MinMaxScaler', categorical_transformer, mm_columns)
              ],
          ...
          logging.info("Final Preprocessing Pipeline Ready!")
          logging.info("Exiting from get_data_transformed_object method of DataTransformation class")
    ...
    def _map_gender_column(self, df: DataFrame) -> DataFrame:
        ...
        logging.info("Mapping 'Gender' column to numerical values")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
      ...
      try:
        ...
        logging.info("Input and Target features defined for both train and test data.")
        ...
        logging.info("Got the data preprocessing object")
        
        logging.info("Initiating transformation on train data")
        input_feature_train_arr = preprocessor.fit_transform(input_feature_train_df)
        logging.info("Initiating transformation on test data")
        input_feature_test_arr = preprocessor.transform(input_feature_test_df)
        
        logging.info("Data transformation done for train and test data")
        ...
        logging.info("SMOTEENN applied on both train and test data")
        
        train_arr = np.c_[input_feature_train_final, np.array(target_feature_train_final)]
        test_arr = np.c_[input_feature_test_final, np.array(target_feature_test_final)]
        logging.info("Concatination of input and target array done for both train and test data")
        
        save_object(self.data_transformation_config.transformed_object_file_path, preprocessor)
        save_numpy_array_data(self.data_transformation_config.transformed_train_file_path, train_arr)
        save_numpy_array_data(self.data_transformation_config.transformed_test_file_path, test_arr)
        
        logging.info("Data Transformation done successfully and artifacts saved.")
